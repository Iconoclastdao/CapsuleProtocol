...
const HARD_CODED_CONTRACT_ADDRESS = "0x191A696C557995a409ACCD2efc158421Bca11bDB"; // Replace with your contract address
...
const CapsulePrivacyModule: React.FC = () => {
   ...
   return (
    <div style={{
      ...
      <h2 style={{ fontSize: "26px", fontWeight: "bold", marginBottom: "16px", textAlign: "center" }}>
        Iconoclast Capsule Privacy Module
      </h2>
...
export default CapsulePrivacyModule;