...
const navItems = [
   ...
   { route: "/Coincapsule", label: "Coincapsule", emoji: "📄", component: "Coincapsule" },
    { route: "/CapsulePrivacyModule", label: "CapsulePrivacyModule", emoji: "📄", component: "CapsulePrivacyModule" },
     { route: "/CapsuleLegacyModule", label: "CapsuleLegacyModule", emoji: "📄", component: "CapsuleLegacyModule" },
      { route: "/CapsuleTimelineModule", label: "CapsuleTimelineModule", emoji: "📄", component: "CapsuleTimelineModule" },
