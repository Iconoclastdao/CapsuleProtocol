...
const HARD_CODED_CONTRACT_ADDRESS = "0xc4151c6759410a00669B40C6AeDeDb95B3d04200"; // Replace with your contract address
...
const CapsuleTimelineModule: React.FC = () => {
   ...
   return (
    <div style={{
      ...
      <h2 style={{ fontSize: "26px", fontWeight: "bold", marginBottom: "16px", textAlign: "center" }}>
        Iconoclast Capsule Timeline Module
      </h2>
...
export default CapsuleTimelineModule;