...
const HARD_CODED_CONTRACT_ADDRESS = "0x705D6a36746f9597F94798Ea30B4FfFAA0045305"; // Replace with your contract address
...
const CapsuleLegacyModule: React.FC = () => {
   ...
   return (
    <div style={{
      ...
      <h2 style={{ fontSize: "26px", fontWeight: "bold", marginBottom: "16px", textAlign: "center" }}>
        Iconoclast Capsule Legacy Module
      </h2>
...
export default CapsuleLegacyModule;
;