...
import Coincapsule from "./components/Coincapsule";
import CapsuleLegacyModule from "./components/CapsuleLegacyModule";
import CapsulePrivacyModule from "./components/CapsulePrivacyModule";
import CapsuleTimelineModule from "./components/CapsuleTimelineModule";
        ...
        <MainContent>
          <TopSection>
            ...
            <Routes>
              ...
              <Route path="/Coincapsule" element={<Coincapsule />} />
              <Route path="/TokenPriceChart" element={<TokenPriceChart />} />
              <Route path="/CapsuleLegacyModule" element={<CapsuleLegacyModule />} />
              <Route path="/CapsulePrivacyModule" element={<CapsulePrivacyModule />} />
              <Route path="/CapsuleTimelineModule" element={<CapsuleTimelineModule />} />
